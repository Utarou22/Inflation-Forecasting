...
Path("tables_island").mkdir(exist_ok=True)
Path("visuals_island").mkdir(exist_ok=True)
...
macro_external_monthly.to_html("tables_island/1.0.a Macro External Monthly.html")
...
df_main["region"] = (
    ...
    .astype(str)
    .str.strip()
    .map(REGION_TO_ISLAND)
    .fillna(df_main["region"].astype(str).str.strip())
)
df_main = (
    df_main.loc[df_main["month"].notna() & df_main["price"].notna(), ["region", "commodity_name", "month", "price"]]
    .groupby(["region", "commodity_name", "month"], as_index=False)
...
print_table(
    "Island-Level Series Coverage",
    df_main.groupby("region", as_index=False)
    .agg(
        commodities=("commodity_name", "nunique"),
        monthly_rows=("month", "size"),
    )
    .sort_values("region")
    .reset_index(drop=True)
)
...
granger_overview.to_html("tables_island/1.1.a Granger Causality Test Overview.html")
global_driver_shortlist.to_html("tables_island/1.1.b Global Driver Shortlist.html")
global_shortlisted_driver_table.to_html("tables_island/1.1.c Global Shortlisted Driver.html")
...
eligibility_overview.to_html("tables_island/1.3.a Eligibility Overview.html", index=False)
eligible_series_manifest.to_html("tables_island/1.3.b Eligible Series Manifest.html", index=False)
...
evaluation_setup.to_html("tables_island/1.3.c Evaluation Setup.html", index=False)
split_readiness.to_html("tables_island/1.3.d Split Readiness.html", index=False)
...
stationarity_overview.to_html("tables_island/1.4.a Stationarity Overview.html", index=False)
stationarity_results.to_html("tables_island/1.4.b Stationarity Results.html", index=False)
...
seasonality_overview.to_html("tables_island/1.4.c Seasonality Overview.html", index=False)
seasonality_results.to_html("tables_island/1.4.d Seasonality Results.html", index=False)
...
top_seasonal_candidates.to_html("tables_island/1.4.e Top Seasonal Candidates.html", index=False)
...
sarima_readiness_overview.to_html("tables_island/1.4.f SARIMA Readiness Overview.html", index=False)
sarima_readiness.to_html("tables_island/1.4.g SARIMA Readiness.html", index=False)
...
ax.grid(alpha=0.3)
fig.tight_layout()
plt.savefig("visuals_island/1.4.a Series Length Distribution.png", dpi=200, bbox_inches="tight")
plt.close()
...
ax.grid(alpha=0.3)
fig.tight_layout()
plt.savefig("visuals_island/1.4.b Lag12 Autocorrelation Distribution.png", dpi=200, bbox_inches="tight")
plt.close()
...
if not heatmap_data.empty:
    ...
    fig.tight_layout()
    plt.savefig("visuals_island/1.4.c Seasonal Heatmap Top Candidates.png", dpi=200, bbox_inches="tight")
    plt.close()
...
if representative_series_id is not None:
    ...
    fig.tight_layout()
    plt.savefig("visuals_island/1.4.d Representative Stationarity Diagnostics.png", dpi=200, bbox_inches="tight")
    plt.close()
    ...
    if representative_target.shape[0] >= 24:
        ...
        decomposition_fig.savefig("visuals_island/1.4.e Representative Seasonal Decomposition.png", dpi=200, bbox_inches="tight")
    ...
    if max_lag >= 12:
        ...
        fig.tight_layout()
        plt.savefig("visuals_island/1.4.f Representative ACF PACF.png", dpi=200, bbox_inches="tight")
        plt.close()
...
sarima_search_space.to_html("tables_island/2.1.a SARIMA Search Space.html", index=False)
...
sarima_run_overview.to_html("tables_island/2.1.b SARIMA Run Overview.html", index=False)
sarima_model_settings.to_html("tables_island/2.1.c SARIMA Model Settings.html", index=False)
sarima_predictions.to_html("tables_island/2.1.d SARIMA Predictions.html", index=False)
...
sarima_global_metrics.to_html("tables_island/2.1.e Global Forecast Metrics.html", index=False)
...
sarima_series_metrics.to_html("tables_island/2.1.f Series Forecast Metrics.html", index=False)

sarima_residual_diagnostics = hf.compute_diagnostics(sarima_predictions, prediction_pairs)
sarima_residual_diagnostics.to_html("tables_island/2.1.g Residual Diagnostics.html", index=False)
...
if not sarima_global_metrics.empty:
    ...
    fig.tight_layout()
    plt.savefig("visuals_island/2.2.a Benchmark RMSE Comparison.png", dpi=200, bbox_inches="tight")
    plt.close()
...
if not sarima_model_settings.empty:
    ...
    sarima_order_frequency.to_html("tables_island/2.1.h SARIMA Order Frequency.html", index=False)
    ...
    fig.tight_layout()
    plt.savefig("visuals_island/2.2.b SARIMA Order Frequency.png", dpi=200, bbox_inches="tight")
    plt.close()
...
if not sarima_series_metrics.empty:
    ...
    if not example_series.empty:
        ...
        fig.tight_layout()
        plt.savefig("visuals_island/2.2.c Best Example Holdout Forecasts.png", dpi=200, bbox_inches="tight")
        plt.close()
...
svr_feature_manifest.to_html("tables_island/3.1.a SVR Feature Manifest.html", index=False)
...
svr_run_overview.to_html("tables_island/3.1.b SVR Run Overview.html", index=False)
svr_model_settings.to_html("tables_island/3.1.c SVR Model Settings.html", index=False)
non_linear_predictions.to_html("tables_island/3.1.d SVR Predictions.html", index=False)
svr_global_metrics.to_html("tables_island/3.1.e SVR Global Metrics.html", index=False)
svr_series_metrics.to_html("tables_island/3.1.f SVR Series Metrics.html", index=False)
svr_residual_diagnostics.to_html("tables_island/3.1.g SVR Residual Diagnostics.html", index=False)
...
if not svr_global_metrics.empty:
    ...
    ax.grid(axis="y", alpha=0.3)
    fig.tight_layout()
    plt.savefig("visuals_island/3.2.a SVR Benchmark RMSE Comparison.png", dpi=200, bbox_inches="tight")
    plt.close()
...
if not svr_series_metrics.empty:
    ...
    if not example_series.empty:
        ...
        axes[-1].set_xlabel("Holdout month")
        fig.tight_layout()
        plt.savefig("visuals_island/3.2.b Best Example SVR Forecasts.png", dpi=200, bbox_inches="tight")
        plt.close()
...
lightgbm_feature_manifest.to_html("tables_island/4.1.a LightGBM Feature Manifest.html", index=False)
...
lightgbm_run_overview.to_html("tables_island/4.1.b LightGBM Run Overview.html", index=False)
lightgbm_model_settings.to_html("tables_island/4.1.c LightGBM Model Settings.html", index=False)
lightgbm_predictions.to_html("tables_island/4.1.d LightGBM Predictions.html", index=False)
lightgbm_global_metrics.to_html("tables_island/4.1.e LightGBM Global Metrics.html", index=False)
lightgbm_series_metrics.to_html("tables_island/4.1.f LightGBM Series Metrics.html", index=False)
lightgbm_diagnostics.to_html("tables_island/4.1.g LightGBM Diagnostics.html", index=False)
...
if not lightgbm_global_metrics.empty:
    ...
    ax.grid(axis="y", alpha=0.3)
    fig.tight_layout()
    plt.savefig("visuals_island/4.2.a LightGBM Benchmark RMSE Comparison.png", dpi=200, bbox_inches="tight")
    plt.close()
...
ensemble_weights.to_html("tables_island/5.1.a Ensemble Weights.html", index=False)
weight_concentration_summary.to_html("tables_island/5.1.b Ensemble Weight Summary.html", index=False)
ensemble_predictions.to_html("tables_island/5.1.c Ensemble Predictions.html", index=False)
ensemble_global_metrics.to_html("tables_island/5.1.d Ensemble Global Metrics.html", index=False)
ensemble_series_metrics.to_html("tables_island/5.1.e Ensemble Series Metrics.html", index=False)
ensemble_diagnostics.to_html("tables_island/5.1.f Ensemble Diagnostics.html", index=False)
ensemble_series_diagnostics.to_html("tables_island/5.1.g Ensemble Series Diagnostics.html",index=False)
diagnostic_summary.to_html("tables_island/5.1.h Ensemble Diagnostic Summary.html",index=False)
...
if not ensemble_global_metrics.empty:
    ...
    ax.grid(axis="y", alpha=0.3)
    fig.tight_layout()
    plt.savefig("visuals_island/5.2.a Ensemble Benchmark RMSE Comparison.png", dpi=200, bbox_inches="tight")
    plt.close()
...
if not ensemble_series_metrics.empty:
    ...
    if not example_ensemble_series.empty:
        ...
        fig.tight_layout()
        plt.savefig("visuals_island/5.2.b Best Ensemble Forecasts.png", dpi=200, bbox_inches="tight")
        plt.close()
